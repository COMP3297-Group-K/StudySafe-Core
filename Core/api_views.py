...
# class ContactVenueViewSet(ReadOnlyModelViewSet):
...
@api_view(['GET',])
def ContactVenue(request, hkuID, date): #https://django.cowhite.com/blog/working-with-url-get-post-parameters-in-django/
...
# class ContactMemberViewSet(ReadOnlyModelViewSet):
#     queryset = ExitEntryRecord.objects.all()
